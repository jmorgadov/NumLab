...
class Parser:
    ...
    def _build_slr_atmt(self):
        ...
        logging.debug(f"Exacted items in the SLR automata:")
    ...
    def parse_tokens(self, tokens: List[Token], method: str = "slr") -> AST:
        ...
        if method == "slr":
            ...
            return self._ll_parse_tokens(tokens)
        else:
    ...
    def _ll_parse_tokens(self, tokens: List[Token]) -> AST:
        """Parses a list of tokens.
            ...
            for expr, prod in self.grammar.all_productions():
                for i, item in enumerate(prod.items):
                    ...
                    if next_item is None:
                        ...
                        change |= follow[item.name].update(self._first[next_item] - "EPS")
